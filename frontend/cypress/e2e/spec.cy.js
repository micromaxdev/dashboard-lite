describe('My First Test', () => {
  ...
  it('Invite participants', () => {
    ...
    cy.get('#filter-demo-option-0').click();
    cy.get('#root > main > div > div.MuiGrid-root.MuiGrid-container > main > div.makeStyles-mainSpacing-38 > div > div.MuiGrid-root.MuiGrid-container.MuiGrid-spacing-xs-3.css-1n52r5g-MuiGrid-root > div > div:nth-child(3) > div > div.MuiFormControl-root.css-wn9fke-MuiFormControl-root > div').click();
    cy.get('[data-value="kris.godina@outlook.com"]').click();
    cy.get('[data-value="krisgodina@outlook.com"]').click();
    ...
    cy.get(':nth-child(3) > :nth-child(5) > .MuiButtonBase-root').click();
    cy.get('.MuiPaper-root > :nth-child(3) > .MuiFormControl-root').click();
    cy.get(':nth-child(3) > .MuiFormControl-root > .MuiOutlinedInput-root > #outlined-multiline-static').clear();
    cy.get(':nth-child(3) > .MuiFormControl-root > .MuiOutlinedInput-root > #outlined-multiline-static').type('9:00am');
    cy.get(':nth-child(4) > .MuiFormControl-root > .MuiOutlinedInput-root > #outlined-multiline-static').clear('c');
    cy.get(':nth-child(4) > .MuiFormControl-root > .MuiOutlinedInput-root > #outlined-multiline-static').type('conference room');
    cy.get('.MuiButton-root').click();
  })
  ...
  it('CA Sign Off', () => {
    ...
    cy.get('.caSignOffDropdown').click()
    cy.get('#filter-demo-option-0').click({force: true})
  })
